        ...
        <div class="row">
            <div class="col-lg-8">
                <div class="mb-5">
                    ...
                    <img class="img-fluid rounded w-100 mb-4" src="{{asset('storage/images/'.$course->image)}}" alt="Image">
            ...
            <div class="col-lg-4 mt-5 mt-lg-0">
                <div class="bg-primary mb-5 py-3">
                    ...
                    <div class="d-flex justify-content-between border-bottom px-4">
                        ...
                        <h6 class="text-white my-3">{{$course->instructor_name}}</h6>
                    </div>
                    <div class="d-flex justify-content-between border-bottom px-4">
                    ...
                    <h5 class="text-white py-3 px-4 m-0">Course Price: ৳{{$course->regular_price}}</h5>
                    <div class="py-3 px-4">
                ...
                <div class="mb-5">
                    ...
                    <a class="d-flex align-items-center text-decoration-none mb-4" href="">
                        <img class="img-fluid rounded" src="{{asset('asset/img/courses-80x80.jpg')}}" alt="">
                        <div class="pl-3">
